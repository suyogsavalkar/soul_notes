...
extension FileManager {
    ...
    var notesDirectory: URL {
        let directory = documentsDirectory.appendingPathComponent("Notes")
...
class ErrorHandler {
    func handle(_ error: Error, context: String) {
        ...
        // In a production app, you might want to log to crash analytics
        // or show user-facing error messages
    }
}
